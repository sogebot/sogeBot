...
describe('Custom Commands - visible()', () => {
  ...
  it('', async () => {
    global.systems.customCommands.visible({ sender: owner, parameters: '' })
    await message.isSent('customcmds.commands-parse-failed', owner, { sender: owner.username })
  })

  it('!unknown', async () => {
    global.systems.customCommands.visible({ sender: owner, parameters: '!unknown' })
  ...
  it('!한글', async () => {
    ...
    global.systems.customCommands.visible({ sender: owner, parameters: '!한글' })
  ...
  it('!русский', async () => {
    ...
    global.systems.customCommands.visible({ sender: owner, parameters: '!русский' })
