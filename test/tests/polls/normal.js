...
describe('Polls - normal', () => {
  ...
  describe('Voting full workflow', () => {
    ...
    it(`!vote should return correct vote status`, async () => {
      ...
      await message.isSentRaw(global.systems.polls.settings.commands['!vote'] + ` 1 - Lorem - 0 ${global.commons.getLocalizedName(0, 'systems.polls.votes')}, 0.00%`, owner)
      await message.isSentRaw(global.systems.polls.settings.commands['!vote'] + ` 2 - Ipsum - 0 ${global.commons.getLocalizedName(0, 'systems.polls.votes')}, 0.00%`, owner)
      await message.isSentRaw(global.systems.polls.settings.commands['!vote'] + ` 3 - Dolor Sit - 0 ${global.commons.getLocalizedName(0, 'systems.polls.votes')}, 0.00%`, owner)
    })
    ...
    it(`!vote should return correct vote status`, async () => {
      ...
      await global.systems.polls.main({ sender: owner, parameters: ''  })
      await message.isSent('systems.polls.status', owner, { title: 'Lorem Ipsum?' })
      await message.isSentRaw(global.systems.polls.settings.commands['!vote'] + ` 1 - Lorem - 10 ${global.commons.getLocalizedName(10, 'systems.polls.votes')}, 47.62%`, owner)
      await message.isSentRaw(global.systems.polls.settings.commands['!vote'] + ` 2 - Ipsum - 10 ${global.commons.getLocalizedName(10, 'systems.polls.votes')}, 47.62%`, owner)
      await message.isSentRaw(global.systems.polls.settings.commands['!vote'] + ` 3 - Dolor Sit - 1 ${global.commons.getLocalizedName(1, 'systems.polls.votes')}, 4.76%`, owner)
    })
