...
describe('Raffles - announce should contain delete info #4176', () => {
  ...
  it('create ticket raffle', async () => {
    ...
    await message.isSentRaw('Raffle is running (0 entries). To enter type "!winme <1-100>". Raffle is opened for everyone. Your raffle messages will be deleted on join.', { username: '__bot_username__' })
  });
  ...
  it('expecting 2 entries in announce message', async () => {
    ...
    await message.isSentRaw('Raffle is running (150 entries). To enter type "!winme <1-100>". Raffle is opened for everyone. Your raffle messages will be deleted on join.', { username: '__bot_username__' })
  });
});
