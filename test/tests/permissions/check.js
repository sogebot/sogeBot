...
const users = [
  ...
  { username: '__follower__', userId: 4, id: 4, is: { follower: true }, stats: { subStreak: 0, subCumulativeMonths: 0 } },
  { username: '__viewer__', userId: 5, id: 5, stats: { subStreak: 0, subCumulativeMonths: 0 } },
  { username: '__viewer_points__', userId: 6, id: 6, stats: { subStreak: 0, subCumulativeMonths: 0 } },
  { username: '__viewer_watched__', userId: 7, id: 7, stats: { subStreak: 0, subCumulativeMonths: 0 } },
  { username: '__viewer_tips__', userId: 8, id: 8, stats: { subStreak: 0, subCumulativeMonths: 0 } },
  { username: '__viewer_bits__', userId: 9, id: 9, stats: { subStreak: 0, subCumulativeMonths: 0 } },
  { username: '__viewer_messages__', userId: 10, id: 10, stats: { subStreak: 0, subCumulativeMonths: 0 } },
  { username: '__viewer_subtier__', userId: 11, id: 11, stats: { tier: 2, subStreak: 0, subCumulativeMonths: 0 } },
  { username: '__viewer_subcumulativemonths__', userId: 12, id: 12, stats: { subCumulativeMonths: 2, subStreak: 0 } },
  { username: '__viewer_substreakmonths__', userId: 13, id: 13, stats: { subStreak: 2, subCumulativeMonths: 0 } },
]
...
describe('Permissions - check()', () => {
  beforeEach(async () => {
    ...
    await global.db.engine.insert('users.points', { id: 6, points: 100 })
    await global.db.engine.insert('users.watched', { id: 7, watched: 100 * (60 * 60 * 1000 /*hours*/) })
    await global.db.engine.insert('users.tips', { id: 8, currency: 'EUR', amount: 100 })
    await global.db.engine.insert('users.bits', { id: 9, amount: 100 })
    await global.db.engine.insert('users.messages', { id: 10, messages: 100 })
  })
