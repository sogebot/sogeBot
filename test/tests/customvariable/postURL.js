...
describe('Custom Variable - helpers/customvariables/postURL', () => {
  ...
  it ('with enabled POST - correct value', async () => {
    ...
    await message.isNotSentRaw('@bot, $_variable2 was set to 101.', '__bot_username__');
    await message.isNotSentRaw('This is custom update text: 101', '__bot_username__');
  });
  ...
  it ('with enabled POST and response type 0 - correct value', async () => {
    ...
    assert.strictEqual(res._toSend.code, undefined);
    assert.strictEqual(res._status, 200);
    await message.isSentRaw('@bot, $_variable2 was set to 101.', '__bot_username__');
  });
  ...
  it ('with enabled POST and response type 1 - correct value', async () => {
    ...
    assert.strictEqual(res._toSend.code, undefined);
    assert.strictEqual(res._status, 200);
    await message.isSentRaw('This is custom update text: 101', '__bot_username__');
  });
