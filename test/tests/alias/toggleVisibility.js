...
describe('Alias - toggleVisibility()', () => {
  ...
  it('', async () => {
    alias.toggleVisibility({ sender: owner, parameters: '' });
    await message.isSent('alias.alias-parse-failed', owner, { sender: owner.username });
  });

  it('!unknown', async () => {
    alias.toggleVisibility({ sender: owner, parameters: '!unknown' });
  ...
  it('!a', async () => {
    ...
    alias.toggleVisibility({ sender: owner, parameters: '!a' });
  ...
  it('!a with spaces', async () => {
    ...
    alias.toggleVisibility({ sender: owner, parameters: '!a with spaces' });
  ...
  it('!한국어', async () => {
    ...
    alias.toggleVisibility({ sender: owner, parameters: '!한국어' });
  ...
  it('!русский', async () => {
    ...
    alias.toggleVisibility({ sender: owner, parameters: '!русский' });
