...
export class generatedMigration1643142258874 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`user\` ADD \`followedAt\` varchar(24) NULL`);
    await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`subscribedAt\``);
    await queryRunner.query(`ALTER TABLE \`user\` ADD \`subscribedAt\` varchar(24) NULL`);
    await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`seenAt\``);
    await queryRunner.query(`ALTER TABLE \`user\` ADD \`seenAt\` varchar(24) NULL`);
    await queryRunner.query(`ALTER TABLE \`user\` DROP COLUMN \`createdAt\``);
    await queryRunner.query(`ALTER TABLE \`user\` ADD \`createdAt\` varchar(24) NULL`);
