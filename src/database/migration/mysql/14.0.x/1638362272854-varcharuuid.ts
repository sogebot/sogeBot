...
export class varcharUUID1638362272853 implements MigrationInterface {
  name = 'varcharUUID1638362272853';
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('ALTER TABLE `checklist` MODIFY `id` varchar(255) NOT NULL', undefined);
    ...
    await queryRunner.query(`ALTER TABLE \`goal\` MODIFY \`groupId\` varchar(255) NULL`);
    ...
    await queryRunner.query(`ALTER TABLE \`how_long_to_beat_game_item\` MODIFY \`hltb_id\` varchar(255) NOT NULL`);
    await queryRunner.query(`ALTER TABLE \`google_private_keys\` MODIFY \`id\` varchar(36) NOT NULL`);
    ...
    await queryRunner.query(`ALTER TABLE \`randomizer_item\` MODIFY \`randomizerId\` varchar(255) NULL`);
