...
export class updateOverlayToGroup1675089806897 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE \`overlay\` (\`id\` varchar(36) NOT NULL, \`name\` varchar(255) NOT NULL, \`canvas\` json NOT NULL, \`items\` json NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
