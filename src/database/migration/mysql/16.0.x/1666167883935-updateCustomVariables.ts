...
export class updateCustomVariables1666167883935 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`variable\` ADD UNIQUE INDEX \`IDX_dd084634ad76dbefdca837b8de\` (\`variableName\`)`);
    await queryRunner.query(`ALTER TABLE \`variable\` DROP COLUMN \`runAt\``);
    await queryRunner.query(`ALTER TABLE \`variable\` ADD \`runAt\` varchar(30) NOT NULL`);
