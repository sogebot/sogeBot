...
export class updateSongs1666167883933 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE \`song_playlist\` ADD \`lastPlayedAt\` varchar(30) NOT NULL DEFAULT '1970-01-01T00:00:00.000Z'`);
    await queryRunner.query(`ALTER TABLE \`song_request\` DROP COLUMN \`addedAt\``);
    await queryRunner.query(`ALTER TABLE \`song_request\` ADD \`addedAt\` varchar(30) NOT NULL`);
