...
export class alertsHostRemoveAutohost1609951363191 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`ALTER TABLE "alert_raid" ADD "showAutoHost" boolean NOT NULL`);
    await queryRunner.query(`ALTER TABLE "alert_host" ADD "showAutoHost" boolean NOT NULL`);
  }
