...
export class generatedMigration1643142258874 implements MigrationInterface {
  name = 'generatedMigration1643142258874';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "user" ADD "followedAt" character varying(24)`);
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "subscribedAt"`);
    await queryRunner.query(`ALTER TABLE "user" ADD "subscribedAt" character varying(24)`);
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "seenAt"`);
    await queryRunner.query(`ALTER TABLE "user" ADD "seenAt" character varying(24)`);
    await queryRunner.query(`ALTER TABLE "user" DROP COLUMN "createdAt"`);
    await queryRunner.query(`ALTER TABLE "user" ADD "createdAt" character varying(24)`);
