...
export class retypeTimestampAttribute1659639416172 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "cooldown_viewer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" character varying NOT NULL, "timestamp" character varying(30) NOT NULL, "cooldownId" uuid, CONSTRAINT "PK_623cc80522fb1bb56c7b907c59f" PRIMARY KEY ("id"))`);
