...
export class eventsUpdate1678892044036 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "event" ("id" uuid NOT NULL DEFAULT uuid_generate_randomUUID(), "isEnabled" boolean NOT NULL, "filter" character varying NOT NULL, "operations" json NOT NULL, "eventName" text NOT NULL, "eventTriggered" json NOT NULL, "eventDefinitions" json NOT NULL, CONSTRAINT "PK_30c2f3bbaf6d34a55f8ae6e4614" PRIMARY KEY ("id"))`);
