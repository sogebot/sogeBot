...
export class timerAttrChange1661765436386 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "timer" ADD "triggeredAtTimestamp" character varying(30) NOT NULL DEFAULT '1970-01-01T00:00:00.000Z'`);
    await queryRunner.query(`ALTER TABLE "timer" DROP COLUMN "triggeredAtMessages"`);
    await queryRunner.query(`ALTER TABLE "timer" ADD "triggeredAtMessages" integer NOT NULL DEFAULT '0'`);
