...
export class updateOverlayToGroup1675089806897 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "overlay" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying NOT NULL, "canvas" json NOT NULL, "items" json NOT NULL, CONSTRAINT "PK_2abda96f999ea44fd200bfef741" PRIMARY KEY ("id"))`);    const items = await queryRunner.query(`SELECT * from "overlay_mapper"`);
