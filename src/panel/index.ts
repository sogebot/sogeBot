  ...
  if (store.state.loggedUser !== false) {
    ...
    const router = new VueRouter({
      ...
      routes: [
        ...
        { path: '/manage/keywords/edit/:id?', name: 'KeywordsManager', component: () => import('./views/managers/keyword.vue') },
        ...
        { path: '/manage/price/edit/:id?', name: 'PriceManager', component: () => import('./views/managers/price.vue') },
