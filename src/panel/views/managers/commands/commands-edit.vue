      ...
      <b-form-group>
        ...
        <div style="display: flex; flex: 1 1 auto" :key="i" :class="[i !== 0 ? 'pt-2' : '']" v-for="(response, i) of orderBy(item.responses, 'order', 'asc')">
          ...
          <textarea-with-tags
            ...
            v-bind:filters="['sender', 'source', 'haveParam', 'is.moderator', 'is.subscriber', 'is.vip', 'is.follower', 'is.broadcaster', 'is.bot', 'is.owner', 'rank', 'game', 'language', 'title', 'views', 'followers', 'hosts', 'subscribers']"></textarea-with-tags>
