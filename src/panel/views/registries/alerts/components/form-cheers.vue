<template>
  <div>
    ...
    <b-card no-body>
      ...
      <b-collapse :id="'accordion-2' + data.id" accordion="message-accordion" role="tabpanel">
        <b-card-body>
          <b-form-group
            label-cols-sm="4"
            label-cols-lg="3"
            ...
            <b-form-input
              ...
              @input="$v.data.$touch()"
              :state="$v.data.message.minAmountToShow.$invalid && $v.data.message.minAmountToShow.$dirty ? false : null"
            ></b-form-input>
          </b-form-group>
          ...
          <b-form-group label-cols-sm="4" label-cols-lg="3"
                  ...
                  :label-for="'message.font.size' + data.id">
            <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
              <b-form-input
                :id="'message.font.size' + data.id"
          ...
          <b-form-group label-cols-sm="4" label-cols-lg="3"
                  ...
                  :label-for="'message.font.weight' + data.id">
            <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
              <b-form-input
                :id="'message.font.weight' + data.id"
          ...
          <b-form-group label-cols-sm="4" label-cols-lg="3"
                  ...
                  :label-for="'message.font.borderPx' + data.id">
            <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
              <b-form-input
                :id="'message.font.borderPx' + data.id"
          ...
          <b-form-group label-cols-sm="4" label-cols-lg="3"
                  ...
                  :label-for="'message.font.borderColor' + data.id">
            <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
              <b-form-input
                :id="'message.font.borderColor' + data.id"
          ...
          <b-form-group label-cols-sm="4" label-cols-lg="3"
                  ...
                  :label-for="'message.font.color' + data.id">
            <b-input-group class="mb-2 mr-sm-2 mb-sm-0">
              <b-form-input
                :id="'message.font.color' + data.id"
...
export default class AlertsEditCheersForm extends Vue {
  ...
  created() {
    switch (this.$props.event) {
      case 'tips':
        this.rules = [['username', 'string'], ['amount', 'number'], ['currency', 'string'], ['message', 'string']];
        break;
      default:
        this.rules = [['username', 'string'], ['amount', 'number'], ['message', 'string']];
        break;
    }
  }
