...
export class randomizer1575377678628 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`CREATE TABLE "randomizer_item" ("id" varchar PRIMARY KEY NOT NULL, "randomizerId" varchar, "name" varchar NOT NULL, "randomColor" boolean NOT NULL DEFAULT (1), "color" varchar(9), "chanceWeight" integer NOT NULL DEFAULT (100), "numOfDuplicates" integer NOT NULL DEFAULT (1), "minimalSpacing" integer NOT NULL DEFAULT (1))`, undefined);
    ...
    await queryRunner.query(`CREATE TABLE "temporary_randomizer_item" ("id" varchar PRIMARY KEY NOT NULL, "randomizerId" varchar, "name" varchar NOT NULL, "randomColor" boolean NOT NULL DEFAULT (1), "color" varchar(9), "chanceWeight" integer NOT NULL DEFAULT (100), "numOfDuplicates" integer NOT NULL DEFAULT (1), "minimalSpacing" integer NOT NULL DEFAULT (1), CONSTRAINT "FK_f4505c5b831084d188f4d1aabc7" FOREIGN KEY ("randomizerId") REFERENCES "randomizer" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`, undefined);
    await queryRunner.query(`INSERT INTO "temporary_randomizer_item"("id", "randomizerId", "name", "randomColor", "color", "chanceWeight", "numOfDuplicates", "minimalSpacing") SELECT "id", "randomizerId", "name", "randomColor", "color", "chanceWeight", "numOfDuplicates", "minimalSpacing" FROM "randomizer_item"`, undefined);
  ...
  public async down(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`CREATE TABLE "randomizer_item" ("id" varchar PRIMARY KEY NOT NULL, "randomizerId" varchar, "name" varchar NOT NULL, "randomColor" boolean NOT NULL DEFAULT (1), "color" varchar(9), "chanceWeight" integer NOT NULL DEFAULT (100), "numOfDuplicates" integer NOT NULL DEFAULT (1), "minimalSpacing" integer NOT NULL DEFAULT (1))`, undefined);
    await queryRunner.query(`INSERT INTO "randomizer_item"("id", "randomizerId", "name", "randomColor", "color", "chanceWeight", "numOfDuplicates", "minimalSpacing") SELECT "id", "randomizerId", "name", "randomColor", "color", "chanceWeight", "numOfDuplicates", "minimalSpacing" FROM "temporary_randomizer_item"`, undefined);
