...
export class obswebsocket1611675132824 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "obs_websocket" ("id" varchar(20) PRIMARY KEY NOT NULL, "name" varchar NOT NULL, "advancedMode" boolean NOT NULL DEFAULT (0), "advancedModeCode" varchar NOT NULL, "simpleModeTasks" text NOT NULL)`);
  }
