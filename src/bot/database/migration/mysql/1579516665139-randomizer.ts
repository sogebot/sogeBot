...
export class randomizer1579516665139 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query('CREATE TABLE `randomizer` (`id` varchar(36) NOT NULL, `widgetOrder` int NOT NULL DEFAULT -1, `createdAt` bigint NOT NULL DEFAULT 0, `command` varchar(255) NOT NULL, `isShown` tinyint NOT NULL DEFAULT 0, `type` varchar(20) NOT NULL DEFAULT \'simple\', `customizationFont` text NOT NULL, `permissionId` varchar(255) NOT NULL, `name` varchar(255) NOT NULL, UNIQUE INDEX `idx_randomizer_cmdunique` (`command`), PRIMARY KEY (`id`)) ENGINE=InnoDB', undefined);
