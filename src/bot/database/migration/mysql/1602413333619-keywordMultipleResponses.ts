...
export class keywordMultipleResponses1602413333619 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('CREATE TABLE `keyword_responses` (`id` varchar(36) NOT NULL, `order` int NOT NULL, `response` text NOT NULL, `stopIfExecuted` tinyint NOT NULL, `permission` varchar(255) NOT NULL, `filter` varchar(255) NOT NULL, `keywordId` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB');
