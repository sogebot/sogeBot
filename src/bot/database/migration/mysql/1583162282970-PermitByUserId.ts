...
export class PermitByUserId1583162282970 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('CREATE TABLE `moderation_warning` (`id` int NOT NULL AUTO_INCREMENT, `username` int NOT NULL, `timestamp` bigint NOT NULL DEFAULT 0, PRIMARY KEY (`id`)) ENGINE=InnoDB', undefined);
    await queryRunner.query('CREATE TABLE `moderation_permit` (`id` int NOT NULL AUTO_INCREMENT, `username` int NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB', undefined);
