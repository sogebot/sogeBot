...
export class obswebsocket1611675132824 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('CREATE TABLE `obswebsocket` (`id` int NOT NULL, `name` varchar(255) NOT NULL, `advancedMode` tinyint NOT NULL DEFAULT 0, `advancedModeCode` text NOT NULL, `simpleModeTasks` text NOT NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB');
