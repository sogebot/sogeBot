...
export class schemaAlign1578656819120 implements MigrationInterface {
  name = 'schemaAlign1578656819120';
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('ALTER TABLE `user_tip` CHANGE `message` `message` text NOT NULL DEFAULT \'\'', undefined);
    await queryRunner.query('ALTER TABLE `user_bit` CHANGE `message` `message` text NOT NULL DEFAULT \'\'', undefined);
  }
