...
export class randomizer1575377795642 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('CREATE TABLE `randomizer_item` (`id` varchar(36) NOT NULL, `groupId` varchar(255), `randomizerId` varchar(255) NULL, `name` varchar(255) NOT NULL, `color` varchar(9) NULL, `numOfDuplicates` int NOT NULL DEFAULT 1, `minimalSpacing` int NOT NULL DEFAULT 1, INDEX `IDX_f4505c5b831084d188f4d1aabc` (`randomizerId`), PRIMARY KEY (`id`)) ENGINE=InnoDB', undefined);
