...
export class tipsExchangeRates1584106270435 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query('CREATE TABLE `user_tip` (`id` int NOT NULL AUTO_INCREMENT, `amount` float(12) NOT NULL, `sortAmount` float(12) NOT NULL, `exchangeRates` text NOT NULL, `currency` varchar(255) NOT NULL, `message` text NOT NULL, `tippedAt` bigint NOT NULL DEFAULT 0, `userUserId` int NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB', undefined);
