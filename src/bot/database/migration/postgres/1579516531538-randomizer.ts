...
export class randomizer1579516531538 implements MigrationInterface {
  name = 'randomizer1579516531538';

  public async up(queryRunner: QueryRunner): Promise<any> {
    await queryRunner.query(`CREATE TABLE "randomizer" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "widgetOrder" integer NOT NULL DEFAULT -1, "createdAt" bigint NOT NULL DEFAULT 0, "command" character varying NOT NULL, "isShown" boolean NOT NULL DEFAULT false, "type" character varying(20) NOT NULL DEFAULT 'simple', "customizationFont" text NOT NULL, "permissionId" character varying NOT NULL, "name" character varying NOT NULL, CONSTRAINT "PK_027539f48a550dda46773420ad7" PRIMARY KEY ("id"))`, undefined);
