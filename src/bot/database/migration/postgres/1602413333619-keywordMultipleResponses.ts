...
export class keywordMultipleResponses1602413333619 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "keyword_responses" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "order" integer NOT NULL, "response" text, "stopIfExecuted" boolean NOT NULL, "permission" character varying NOT NULL, "filter" character varying NOT NULL, "keywordId" uuid, CONSTRAINT "PK_3049091cd170cc88ad38bcca63f" PRIMARY KEY ("id"))`, undefined);
