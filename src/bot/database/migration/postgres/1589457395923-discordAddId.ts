...
export class discordAddId1589457395923 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`CREATE TABLE "discord_link" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "discordId" character varying NOT NULL, "tag" character varying NOT NULL, "createdAt" bigint NOT NULL, "userId" integer, CONSTRAINT "PK_51c82ec49736e25315b01dad663" PRIMARY KEY ("id"))`, undefined);
  }
