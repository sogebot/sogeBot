...
export class obswebsocket1611675132824 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "obswebsocket" ("id" integer NOT NULL, "name" character varying NOT NULL, "advancedMode" boolean NOT NULL DEFAULT false, "advancedModeCode" text NOT NULL, "simpleModeTasks" text NOT NULL, CONSTRAINT "PK_e02d10a34d5a7da25a92d4572de" PRIMARY KEY ("id"))`);
