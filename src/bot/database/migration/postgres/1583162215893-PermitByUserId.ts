...
export class PermitByUserId1583162215893 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<any> {
    ...
    await queryRunner.query(`CREATE TABLE "moderation_warning" ("id" SERIAL NOT NULL, "userId" integer, "timestamp" bigint NOT NULL DEFAULT 0, CONSTRAINT "PK_0e90c9d7ff04a18218299cfc0e9" PRIMARY KEY ("id"))`, undefined);
    await queryRunner.query(`CREATE TABLE "moderation_permit" ("id" SERIAL NOT NULL, "userId" integer, CONSTRAINT "PK_ba3b81de5de7feff025898b4a63" PRIMARY KEY ("id"))`, undefined);
