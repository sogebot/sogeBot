...
class Raffles extends System {
  ...
  async announce () {
    ...
    if (!(await global.cache.isOnline()) || _.isEmpty(raffle) || new Date().getTime() - new Date(this.settings._.lastAnnounce).getTime() < ((this.settings.raffleAnnounceInterval) * 60 * 1000)) {
