...
function Keywords(configuration) {
    if (global.configuration.get().systems.keywords === true) {
        ...
        // start interval for registering keywords from DB
        var self = this;
        setInterval(function() {
            self.registerKeywords();
        }, 1000);
    }
...
Keywords.prototype.registerKeywords = function() {
    var self = this;
    database.find({}, function (err, docs) {
        docs.forEach(function(e, i, ar) { global.parser.register('!'+e.keyword, self.customKeyword, constants.VIEWERS);});
    });  
}
...
Keywords.prototype.customKeyword = function(user, msg, fullMsg) {
