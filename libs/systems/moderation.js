...
class Moderation {
  ...
  async permitLink (self, sender, text) {
    try {
      ...
      let m = global.commons.prepare('moderation.user-have-link-permit', { username: parsed[1].toLowerCase(), link: await global.commons.getLocalizedName(count, 'core.links'), count: count })
